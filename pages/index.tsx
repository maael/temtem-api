  ...
  return (
    <ApiBlock example={examples.knownTemtemExample}>
      <>
        ...
        <p>You can extend the <b>trait</b>, <b>technique</b>, and <b>type</b> fields, which then means they will return an array of data in the shape returned by the endpoints below instead of the shape shown here.</p>
      </>
    </ApiBlock>
  )
}
  ...
  return (
    <ApiBlock example={examples.techniqueExample}>
      <>
        ...
        <ApiParamBlock style={{margin: 10}} params={[
          {name: 'names', required: false, description: 'A comma separated list of technique names that you want information about.'},
          {name: 'fields', required: false, description: 'A comma separated list of fields you want returned.'},
        ]} />
  ...
  return (
    <ApiBlock example={examples.traitExample}>
      <>
        ...
        <ApiParamBlock style={{margin: 10}} params={[
          {name: 'names', required: false, description: 'A comma separated list of trait names that you want information about.'},
          {name: 'fields', required: false, description: 'A comma separated list of fields you want returned.'},
        ]} />
...
function CalculateBlock () {
  return (
    <ApiBlock example={examples.weaknessCalculateExample}>
      <>
        <ApiHeader path='/api/weaknesses/calculate' style={{marginBottom: 10}} />
        <ApiParamBlock style={{margin: 10}} params={[
          {name: 'attacking', required: false, description: 'A valid Temtem type to use as the attack value.'},
          {name: 'defending', required: false, description: 'A comma separated list of valid Temtem types to use as the defending values'},
        ]} />
      </>
    </ApiBlock>
  );
